...
def init():
    ...
    sliding_window_sz = rospy.get_param('~sliding_window_sz', 20)   #defines the size of the transformations number used to estimate the helipad's velocity
